...
public class CustomMy extends BaseAdapter {
    Context c;
    ArrayList<SpacecraftMy> spacecraftMies;

    public CustomMy(Context c, ArrayList<SpacecraftMy> spacecraftMies) {
        this.c = c;
        this.spacecraftMies = spacecraftMies;
    }

    @Override
    public int getCount() {
        return spacecraftMies.size();
    }

    @Override
    public Object getItem(int position) {
        return spacecraftMies.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final SpacecraftMy s = (SpacecraftMy)this.getItem(position);
