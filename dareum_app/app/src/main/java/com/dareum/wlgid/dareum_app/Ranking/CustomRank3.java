...
public class CustomRank3 extends BaseAdapter {
    Context c;
    ArrayList<SpacecraftRank> spacecraftRanks;

    public CustomRank3(Context c, ArrayList<SpacecraftRank> spacecraftRanks) {
        this.c = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView==null){
            convertView = LayoutInflater.from(c).inflate(R.layout.ranking_item3,parent,false);
        }
