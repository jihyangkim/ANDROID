...
public class CustomRank4 extends BaseAdapter {
    Context c;
    ArrayList<SpacecraftRank> spacecraftRanks;

    public CustomRank4(Context c, ArrayList<SpacecraftRank> spacecraftRanks) {
        this.c = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView==null){
            convertView = LayoutInflater.from(c).inflate(R.layout.ranking_item4,parent,false);
        }

        //TextView mod_txt1 = (TextView)convertView.findViewById(R.id.mod_txt1);
        TextView mod_txt2 = (TextView)convertView.findViewById(R.id.gender_txt);
