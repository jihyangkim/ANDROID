...
public class DParserRank1 extends AsyncTask<Void,Void,Boolean> {
    Context c;
    String jsonData;
    ListView lv;
    ...
    public DParserRank1(Context c, String jsonData, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(Boolean parsed) {
        ...
        if (parsed){
            //BIND
            CustomRank1 adapter = new CustomRank1(c,spacecrafts1);
