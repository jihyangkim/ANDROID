...
public class DParserRank3 extends AsyncTask<Void,Void,Boolean> {
    Context c;
    String jsonData;
    ListView lv3;
    ...
    public DParserRank3(Context c, String jsonData, ListView lv3) {
        this.c = c;
    ...
    protected void onPostExecute(Boolean parsed) {
        ...
        if (parsed){
            //BIND
            CustomRank3 adapter = new CustomRank3(c,spacecrafts1);
