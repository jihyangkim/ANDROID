...
public class DParserRank4 extends AsyncTask<Void,Void,Boolean> {
    Context c;
    String jsonData;
    ListView lv4;
    ...
    public DParserRank4(Context c, String jsonData, ListView lv4) {
        this.c = c;
    ...
    protected void onPostExecute(Boolean parsed) {
        ...
        if (parsed){
            //BIND
            CustomRank4 adapter = new CustomRank4(c,spacecrafts1);
