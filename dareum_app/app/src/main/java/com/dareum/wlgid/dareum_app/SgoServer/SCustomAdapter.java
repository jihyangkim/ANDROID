...
public class SCustomAdapter extends BaseAdapter {
    Context c;
    ArrayList<SSpacecraft> spacecrafts;

    public SCustomAdapter(Context c, ArrayList<SSpacecraft> spacecrafts) {
        this.c = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final SSpacecraft s = (SSpacecraft)this.getItem(position);
        ...
        SPicassoClient.downloadImage(c,s.getImage(),img);
